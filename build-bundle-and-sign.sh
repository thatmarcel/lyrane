...
codesign \
    ...
    './target/release/bundle/osx/Lyrane (SONOS).app'

if codesign -dv --verbose=4 './target/release/bundle/osx/Lyrane (SONOS).app' 2>&1 | grep "Authority=Developer ID Application" > /dev/null
